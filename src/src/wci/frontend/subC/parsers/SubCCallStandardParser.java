...
import static src.wci.intermediate.icodeimpl.ICodeNodeTypeImpl.CALL;
...
import src.wci.intermediate.symtabimpl.RoutineCodeImpl;

public class SubCCallStandardParser extends SubCCallParser
{
    /**
     * Constructor.
     * @param parent the parent parser.
     */
    public SubCCallStandardParser(SubCParserTD parent)
    {
        super(parent);
    }
