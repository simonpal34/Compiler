...
/**
 * <h1>PascalAssignmentStatementParser</h1>
 *
 ...
 */
public class PascalAssignmentStatementParser extends PascalStatementParser
{
     ...
     */
    public PascalAssignmentStatementParser(PascalParserTD parent)
    {
        super(parent);
    }
    ...
    static {
        ...
        COLON_EQUALS_SET.addAll(PascalStatementParser.STMT_FOLLOW_SET);
    }
        ...
        throws Exception
    {
        ...
        PascalVariableParser variableParser = new PascalVariableParser(this);
