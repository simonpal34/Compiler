...
/**
 * <h1>PascalDeclaredRoutineParser</h1>
 *
 ...
 */
public class PascalDeclaredRoutineParser extends PascalDeclarationsParser
{
    /**
     * Constructor.
     * @param parent the parent parser.
     */
    public PascalDeclaredRoutineParser(PascalParserTD parent)
    {
        super(parent);
    }
        ...
        throws Exception
    {
            ...
            (token.getText().equalsIgnoreCase("forward")))
        {
            ...
            PascalBlockParser blockParser = new PascalBlockParser(this);
    ...
    private static final EnumSet<PascalTokenType> PARAMETER_SET =
        PascalDeclarationsParser.DECLARATION_START_SET.clone();
    static {
    ...
    static {
        PARAMETER_FOLLOW_SET.addAll(PascalDeclarationsParser.DECLARATION_START_SET);
    }
    ...
    static {
        COMMA_SET.addAll(PascalDeclarationsParser.DECLARATION_START_SET);
    }
        ...
        throws Exception
    {
        ...
        if (!isProgram) {
            ...
            else if (PascalVariableDeclarationsParser.
