 ...
 */
class PascalArrayTypeParser extends PascalTypeSpecificationParser
{
    /**
     * Constructor.
     * @param parent the parent parser.
     */
    protected PascalArrayTypeParser(PascalParserTD parent)
    {
        super(parent);
    }
    ...
    private static final EnumSet<PascalTokenType> OF_SET =
        PascalTypeSpecificationParser.TYPE_START_SET.clone();
    static {
        OF_SET.add(OF);
