 ...
 */
class PascalSimpleTypeParser extends PascalTypeSpecificationParser
{
    /**
     * Constructor.
     * @param parent the parent parser.
     */
    protected PascalSimpleTypeParser(PascalParserTD parent)
    {
        super(parent);
    }
        ...
        throws Exception
    {
        ...
        switch ((PascalTokenType) token.getType()) {
            ...
            case IDENTIFIER: {
                ...
                if (id != null) {
                    ...
                    if (definition == DefinitionImpl.TYPE) {
                        ...
                        PascalSubrangeTypeParser subrangeTypeParser =
                            new PascalSubrangeTypeParser(this);
            ...
            case LEFT_PAREN: {
                PascalEnumerationTypeParser enumerationTypeParser =
                    new PascalEnumerationTypeParser(this);
