...
/**
 * <h1>PascalCaseStatementParser</h1>
 *
 ...
 */
public class PascalCaseStatementParser extends PascalStatementParser
{
    /**
     * Constructor.
     * @param parent the parent parser.
     */
    public PascalCaseStatementParser(PascalParserTD parent)
    {
        super(parent);
    }
    ...
    static {
        OF_SET.add(OF);
        OF_SET.addAll(PascalStatementParser.STMT_FOLLOW_SET);
    }
    ...
    static {
        COMMA_SET.add(COMMA);
        COMMA_SET.add(COLON);
        COMMA_SET.addAll(PascalStatementParser.STMT_START_SET);
        COMMA_SET.addAll(PascalStatementParser.STMT_FOLLOW_SET);
    }
