...
/**
 * <h1>PascalConstantDefinitionsParser</h1>
 *
 ...
 */
public class PascalConstantDefinitionsParser extends PascalDeclarationsParser
{
    /**
     * Constructor.
     * @param parent the parent parser.
     */
    public PascalConstantDefinitionsParser(PascalParserTD parent)
    {
        super(parent);
    }
    ...
    private static final EnumSet<PascalTokenType> IDENTIFIER_SET =
        PascalDeclarationsParser.TYPE_START_SET.clone();
    static {
