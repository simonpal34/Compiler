...
/**
 * <h1>PascalVariableDeclarationsParser</h1>
 *
 ...
 */
public class PascalVariableDeclarationsParser extends PascalDeclarationsParser
{
     ...
     */
    public PascalVariableDeclarationsParser(PascalParserTD parent)
    {
        super(parent);
    }
    ...
    static {
        IDENTIFIER_FOLLOW_SET.addAll(PascalDeclarationsParser.VAR_START_SET);
    }
    ...
    static final EnumSet<PascalTokenType> NEXT_START_SET =
        PascalDeclarationsParser.ROUTINE_START_SET.clone();
    static {
