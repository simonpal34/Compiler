...
/**
 * <h1>PascalEnumerationTypeParser</h1>
 *
 ...
 */
public class PascalEnumerationTypeParser extends PascalTypeSpecificationParser
{
    /**
     * Constructor.
     * @param parent the parent parser.
     */
    protected PascalEnumerationTypeParser(PascalParserTD parent)
    {
        super(parent);
    }
    ...
    static {
        ENUM_DEFINITION_FOLLOW_SET.addAll(PascalDeclarationsParser.VAR_START_SET);
    }
