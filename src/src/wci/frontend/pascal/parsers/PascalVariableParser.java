...
import static src.wci.intermediate.symtabimpl.DefinitionImpl.FUNCTION;
...
import static src.wci.intermediate.symtabimpl.DefinitionImpl.VALUE_PARM;
import static src.wci.intermediate.symtabimpl.DefinitionImpl.VAR_PARM;
import static src.wci.intermediate.typeimpl.TypeFormImpl.ARRAY;
 ...
 */
public class PascalVariableParser extends PascalStatementParser
{
     ...
     */
    public PascalVariableParser(PascalParserTD parent)
    {
        super(parent);
    }
